...
class SetCriterion(nn.Module):
    ...
    def loss_ccm(self, outputs, targets, indices, num_boxes):
        losses = {}
        if 'ccm_loss' in outputs:
            losses['ccm_loss'] = outputs['ccm_loss']
        return losses
    ...
    def forward(self, outputs, targets, return_indices=False):
        ...
        if 'aux_outputs' in outputs:
            for idx, aux_outputs in enumerate(outputs['aux_outputs']):
                ...
                for loss in self.losses:
                    if loss == 'masks' or loss == 'ccm': continue
                    kwargs = {}
...
def build_dqdetr(args):
    ...
    weight_dict = {
        'loss_ce': args.cls_loss_coef, 'loss_bbox': args.bbox_loss_coef, 'loss_giou': args.giou_loss_coef,
        'loss_coverage': args.coverage_loss_coef, 'loss_interval': args.interval_loss_coef,
        'loss_spacing': args.spacing_loss_coef, 'ccm_loss': args.ccm_loss_coef
    }
    ...
    losses = ['labels', 'boxes', 'cardinality', 'ccm']
